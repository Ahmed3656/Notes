...
Every document in a MongoDB collection has a unique `_id` field, which is automatically indexed with a **[B-Tree](../Data%20Structures/B-Trees)** to allow for fast lookups.
...
Unlike MongoDB’s [B-Tree](../Data%20Structures/B-Trees) approach, Cassandra is built on **[LSM-Trees](../Data%20Structures/LSM%20Tree%20(Log-Structured%20Merge%20Tree))**.
